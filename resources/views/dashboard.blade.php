...
<div class="dashboard-container">
    ...
    <div class="row">
        ...
        <div class="col-lg-5">
            ...
            <div class="mt-4">
                <!-- Bimbingan Card -->
                <a href="{{ route('ta:bimbingan') }}" class="text-decoration-none mb-4 d-block">
                ...
                <a href="{{ route('ta:sempro') }}" class="text-decoration-none mb-4 d-block">
                ...
                <!-- Sidang TA Card -->
                <a href="{{ route('ta:sidang-ta') }}" class="text-decoration-none d-block">
